...
<script type="text/javascript">
    $(document).ready(function() {
            ...
            $("#ajaxSubmitForm").validate({
                ...
                messages: {
                    buyer: {
                        required:"Please put your Buyer Name.",
                        maxlength: "Maximum 20 character allow.",
                        alphanumeric: "Only text, space and number allow"
                    },
                    buyer_email: "Enter a valid email.",
                    ...
                    $.ajax({
                            ...
                            success: function (res) {
                                    ...
                                    if(obj.error){
                                        ...
                                        $('#subButton').hide();
                                        $("#SuccMsg")
                                            .html("<div id='message'><h4>Buyer Registration Successfully!!</h4></div>")
                                            .append("<p>We will be in touch soon.</p>")
                                            .hide()
                                            .fadeIn(1500, function () {
                                                $("#message").append(
                                                    "<a href='http://localhost/mvc/buyer'>Go Back</a>"
                                                );
                                            });
                                    }
